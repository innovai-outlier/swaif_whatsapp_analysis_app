...
```
NAME                 STATUS
swaif_n8n            Up 8 minutes (healthy)
swaif_n8n_importer   Up 6 seconds
swaif_postgres_n8n   Up 8 minutes (healthy)
swaif_redis_n8n      Up 8 minutes (healthy)
```

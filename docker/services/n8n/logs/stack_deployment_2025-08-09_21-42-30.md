...
```
[2025-08-09 21:42:39] [SUCCESS] n8n Workflow iniciado com sucesso!
[2025-08-09 21:42:44] [INFO] Capturando logs detalhados de n8n Workflow...
...
swaif_n8n            n8nio/n8n:latest     "tini -- /docker-ent‘«™"   swaif_n8n            7 minutes ago   Up 7 minutes (healthy)   0.0.0.0:5678->5678/tcp
swaif_n8n_importer   n8nio/n8n:latest     "/bin/sh -lc ' if [ ‘«™"   swaif_n8n_importer   7 minutes ago   Up 6 seconds             5678/tcp
swaif_postgres_n8n   postgres:15-alpine   "docker-entrypoint.s‘«™"   swaif_postgres_n8n   7 minutes ago   Up 7 minutes (healthy)   0.0.0.0:5434->5432/tcp
swaif_redis_n8n      redis:alpine         "docker-entrypoint.s‘«™"   swaif_redis_n8n      7 minutes ago   Up 7 minutes (healthy)   0.0.0.0:6381->6379/tcp
```
[2025-08-09 21:42:44] [INFO] Verificando sa√∫de dos containers...
